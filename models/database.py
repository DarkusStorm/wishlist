...
DB_PATH = os.getenv('DATABASE', './data/obras.sqlite3')
...
class Database:
    ...
    def __init__(self, db_name: str = DB_PATH) -> None:
        ...
        self.executar('''
            CREATE TABLE IF NOT EXISTS obras(id INTEGER PRIMARY KEY AUTOINCREMENT, titulo_obra TEXT NOT NULL, indicacao_obra TEXT, tipo_obra TEXT NOT NULL);
            ''')
